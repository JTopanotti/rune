...
impl Block {
    ...
    pub(super) fn eval(&self, env: &Env) -> Result<Val, String> {
        ...
        let stmts_excluding_last = &self.stmts[..self.stmts.len() - 1];
        for stmt in stmts_excluding_last {
...
#[cfg(test)]
mod tests {
    use super::super::{Expr, Number, BindingUsage, Val, Env};
    use super::*;
    ...
    #[test]
    fn eval_block_with_def_and_usage() {
        assert_eq!(
            Block {
                stmts: vec![
                    Stmt::BindingDef(BindingDef {
